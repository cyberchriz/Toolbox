...
file(APPEND "${OUTPUT_HEADER}" "// Generated by CMake. Do not edit.\n\n")
...
foreach(SPIRV_FILE ${SPIRV_FILES_LIST})
    ...
    set(VAR_NAME "${FILENAME}_BIN")
    string(TOUPPER "${VAR_NAME}" VAR_NAME) # make all UPPER_CASE
    ...
    file(APPEND "${OUTPUT_HEADER}" "const unsigned char ${VAR_NAME}[] = {\n    ")
