...
// THIS FILE IS ONLY FOR THE PURPOSES OF DEMONSTRATION, TESTING AND DEBUGGING OF THE ngrid.h LIBRARY
...
void ngrid_test() {
	...
	Log::force("The NGrid library implements a vast collection of parallel compute operations on the GPU, using Vulkan.");

	Log::force("\n'NGrid' objects are wrappers for n-dimensional data-structures.");
	...
	Log::force("\nIf a multidimensional source is used, a multi-dimensional offset index is required as follows:");
